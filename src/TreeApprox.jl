...
"""
function tree_approximation!(newtree::Tree, path, nIterations::Int64, p::Int64=2, r::Int64=2)
   # leaf, omega,probaLeaf = leaves(newtree)      # leaves, indexes and probabilities of the leaves of the tree
     leaf, probaLeaf = get_leaves(newtree)      # new version
